...
class SuggestionForm(forms.ModelForm):
    areachoice=[('Ward wise Issues','Ward wise Issues'),('Environmental Concerns During Campaign','Environmental Concerns During Campaign'),('Campaign Ideas','Campaign Ideas'),('Voter Experience Feedback','Voter Experience Feedback'),('Feedback on Candidates','Feedback on Candidates'),('Facilities for Differently-abled & Elderly','Facilities for Differently-abled & Elderly')]
